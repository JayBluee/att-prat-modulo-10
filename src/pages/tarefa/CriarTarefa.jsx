...
const CriarTarefa = ({handleClose, tarefas, setTarefas}) =>{
  ...
  return(
    <Grid container spacing={2}>
      <Card sx={style}>
        <CardHeader
          ...
          subheader="Cadastre sua Tarefa Abaixo"
        /> 
        <CardContent sx={{
          width: '95%',
          maxWidth: '100%',
          ...
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Data de Início</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">Data de Conclusão</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
    ...
    }} size="small" variant="outlined" onClick={handleClose}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
